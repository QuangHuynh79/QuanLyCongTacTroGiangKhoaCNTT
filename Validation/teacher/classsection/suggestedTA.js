$(document).ready(function () {
    $('body').on('click', '[id^="btnXoa-"]', function () {
        var count = $('body').find('[id^="parent-"]').length;
        if (count != 1) {
            var numCurrent = $(this).attr('name');
            $('body').find('[id="parent-' + numCurrent + '"]').replaceWith('');

            $('body').find('[id^="parent-"]').each(function () {
                ...
                if (Number(numCurrent) < Number(numThis)) {
                    ...
                    $('body').find('[id="parent-' + numThis + '"]').attr('name', changNumThis);
                    $('body').find('[id="parent-' + numThis + '"]').attr('id', 'parent-' + changNumThis);
                }
            });
        }
    });

$(document).ready(function () {
    ...
    //Opent
    $('body').find('#parent-user').attr('aria-expanded', 'true');
    $('body').find('#parent-user').removeClass('collapsed');
    $('body').find('#nav-user').addClass('show');
    $('body').find('#child-user-index').addClass('active');
});
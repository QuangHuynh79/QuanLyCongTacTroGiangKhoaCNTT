$(document).ready(function () {
    ...
    //Opent
    $('body').find('#parent-thongke').attr('aria-expanded', 'true');
    $('body').find('#parent-thongke').removeClass('collapsed');
    $('body').find('#nav-thongke').addClass('show');
    $('body').find('#child-thongke-trogiang').addClass('active');
});
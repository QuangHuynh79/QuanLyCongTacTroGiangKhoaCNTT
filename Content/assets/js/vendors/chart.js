...
window.theme = theme,
    function () {
        ...
        $("#earning").length && (e = {
        ...
        }, new ApexCharts(document.querySelector("#earning"), e).render()), $("#earningTwo").length && (e = {
            series: [{
                name: "Current Month",
                data: [10, 20, 15, 25, 18, 28, 22, 32, 24, 34, 26, 38]
            }],
        ...
        }, new ApexCharts(document.querySelector("#earningTwo"), e).render()), $("#order").length && (e = {
            series: [{
                name: "Days",
        ...
        }, new ApexCharts(document.querySelector("#order"), e).render()), $("#traffic").length && (e = {
            dataLabels: {
                enabled: !1
            },
            series: [44, 55, 41],
        ...
        }, new ApexCharts(document.querySelector("#traffic"), e).render()), $("#orderColumn").length && (e = {
            series: [{
        ...
        }, new ApexCharts(document.querySelector("#orderColumn"), e).render()), $("#totalEarning").length && (e = {
            series: [{
        ...
        }, new ApexCharts(document.querySelector("#totalEarning"), e).render()), $("#payoutChart").length && (e = {
            series: [{
                name: "Inflation",
                data: [40, 20, 50, 80, 65]
            }],
        ...
        }, new ApexCharts(document.querySelector("#payoutChart"), e).render()), $("#userChart").length && (e = {
            chart: {
                height: 60,
                type: "area",
                toolbar: {
        ...
        }, new ApexCharts(document.querySelector("#userChart"), e).render()), $("#userChartExample").length && (e = {
            chart: {
                height: 60,
                type: "area",
                toolbar: {
        ...
        }, new ApexCharts(document.querySelector("#userChartExample"), e).render()), $("#userChart").length && (e = {
            chart: {
                height: 60,
                type: "area",
                toolbar: {
        ...
        }, new ApexCharts(document.querySelector("#visitorChart"), e).render()), $("#bounceChart").length && (e = {
            chart: {
                height: 60,
                type: "line",
                toolbar: {
        ...
        }, new ApexCharts(document.querySelector("#bounceChart"), e).render()), $("#support-chart1").length && (e = {
            chart: {
                type: "bar",
                height: 302,
                sparkline: {
        ...
        }, new ApexCharts(document.querySelector("#support-chart1"), e).render()), $("#locationmap").length && new jsVectorMap({
            map: "world",
        ...
        }, new ApexCharts(document.querySelector("#trafficDountChart"), e).render()), $("#operatingSystem").length && (e = {
            series: [55, 88, 80, 75],
        ...
        }, new ApexCharts(document.querySelector("#operatingSystem"), e).render()), $("#expenseChart").length && (e = {
        ...
        }, new ApexCharts(document.querySelector("#expenseChart"), e).render()), $("#taskSummary").length && (e = {
            series: [{
                name: "Closed",
                type: "column",
        ...
        }, new ApexCharts(document.querySelector("#taskSummary"), e).render()), $("#taskSectionchart").length && (e = {
            series: [44, 65, 89, 75],
            chart: {
                height: 400,
                type: "radialBar"
        ...
        }, new ApexCharts(document.querySelector("#taskSectionchart"), e).render()), $("#budgetExpenseChart").length && (e = {
            series: [{
                name: "Series 1",
        ...
        }, new ApexCharts(document.querySelector("#budgetExpenseChart"), e).render()), $(".taskWireframeChart").length && (e = {
            series: [65],
            chart: {
                height: 40,
                width: 40,
            ...
            labels: ["65%"]
        }, new ApexCharts(document.querySelector(".taskWireframeChart"), e).render()), $(".taskPrototypeChart").length && (e = {
            series: [75],
            chart: {
                height: 40,
                width: 40,
            ...
            labels: ["75%"]
        }, new ApexCharts(document.querySelector(".taskPrototypeChart"), e).render()), $(".taskContentChart").length && (e = {
            series: [85],
            chart: {
                height: 40,
                width: 40,
            ...
            labels: ["85%"]
        }, new ApexCharts(document.querySelector(".taskContentChart"), e).render()), $(".taskFigmaChart").length && (e = {
            series: [40],
            chart: {
                height: 40,
                width: 40,
            ...
            labels: ["40%"]
        }, new ApexCharts(document.querySelector(".taskFigmaChart"), e).render()), $(".taskInterfaceChart").length && (e = {
            series: [35],
            chart: {
                height: 40,
                width: 40,
            ...
            labels: ["35%"]
        }, new ApexCharts(document.querySelector(".taskInterfaceChart"), e).render()), $("#taskStatus").length && (e = {
            dataLabels: {
                enabled: !1
            },
            series: [75, 25],
        ...
        }, new ApexCharts(document.querySelector("#taskStatus"), e).render()), $("#progressChart").length && (e = {
            series: [75],
            chart: {
                height: 350,
                type: "radialBar",
        ...
        }, new ApexCharts(document.querySelector("#progressChart"), e).render()), $(".resultChart").length && (e = {
            series: [85],
            chart: {
                height: 110,
                width: 110,

...
! function () {
    ...
    })), $("#dataTableButtons").length && $(document).ready((function () {
    ...
    function () {
        if ($('.theme-switch input[type="checkbox"]').length) {
            const e = document.querySelector('.theme-switch input[type="checkbox"]'),
            ...
            t && (document.documentElement.setAttribute("data-theme", t), "dark" === t && (e.checked = !0)), e.addEventListener("change", n, !1)
        }
    }(),
    function () {
        if ($("#changelog").length) {
            document.getElementById("changelog").innerHTML = "v3.1.0"
        }
    }();
$(document).ready(function () {
    ...
    $('body').on('mouseenter', '[data-bs-toggle="tooltip"]', function () {
        var toolt = $(this);
        toolt.tooltip("show");
    });
